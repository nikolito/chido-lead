...
let pe = localStorage.getItem('polylineEnc');
let pedata = JSON.parse(pe);
let peArray = new Array();

pedata.forEach(function(el) {
  peArray.push(polyline.decode(el));
});

localStorage.setItem('polyline',JSON.stringify(peArray));
